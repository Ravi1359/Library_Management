...
public class Home extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    Intent add_st, add_b, issue_b, book_o, return_b, statistics, logout, update_st, delete_st, update_b, delete_b, view_st, view_bk;
    ...
    public void online_books(View view) {

        book_o = new Intent(this, book_online.class);
        startActivity(book_o);

    }
    public void article(View view) {

        String value = "https://scholar.google.com/";
